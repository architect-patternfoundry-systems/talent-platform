...
def upgrade():
    ...
    # Create indexes
    op.create_index('idx_governance_config_tenant_id', 'governance_config', ['tenant_id'])
    op.create_index('idx_governance_config_nvedo_user_id', 'governance_config', ['nvedo_user_id'])
    op.create_index('idx_pilot_configuration_tenant_id', 'pilot_configuration', ['tenant_id'])
    op.create_index('idx_pilot_configuration_status', 'pilot_configuration', ['status'])
    op.create_index('idx_pilot_metrics_pilot_id', 'pilot_metrics', ['pilot_id'])
    op.create_index('idx_pilot_metrics_week', 'pilot_metrics', ['week'])
    op.create_index('idx_escalation_tenant_id', 'escalation', ['tenant_id'])
    op.create_index('idx_escalation_status', 'escalation', ['status'])
    op.create_index('idx_escalation_pilot_id', 'escalation', ['pilot_id'])
    op.create_index('idx_governance_audit_log_tenant_id', 'governance_audit_log', ['tenant_id'])
    op.create_index('idx_governance_audit_log_action_type', 'governance_audit_log', ['action_type'])
    op.create_index('idx_governance_audit_log_created_at', 'governance_audit_log', ['created_at'])
    op.create_index('idx_job_description_governance_tenant_id', 'job_description_governance', ['tenant_id'])
    op.create_index('idx_job_description_governance_job_id', 'job_description_governance', ['job_id'])
    op.create_index('idx_job_description_governance_status', 'job_description_governance', ['status'])
